...
<body>
    ...
    <div class="weekContainer">
        <div class="calendar">
            ...
            if(!$rezu){}else{$ile=$rezu->num_rows;if($ile>0){echo 'style= "background-color:red"'; }}$conn -> close();}?>></div>
            ...
            <div class="record"<?php $conn = @new mysqli($host, $db_user, $db_pass, $db_name);
